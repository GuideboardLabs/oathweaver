    ...
    def compile(
        ...
        *,
        ...
        payload = {
            ...
            "domain": str(input_payload.get("domain", knowledge.get("domain", input_payload.get("topic_type", "general")))).strip(),
            "topic": str(input_payload.get("topic_type", knowledge.get("topic", input_payload.get("topic_type", "general")))).strip(),
